...
CmdHelp('blacklist').add_command(
    ...
    'addblacklist', '<söz(lər)/cavab>',
        'Sözü qara siyahıya əlavə edər. \'Qara siyahı açar sözündə \' işlədildiyindən bot cavabı silə'
).add_command(
    'rmblacklist', '<söz>',
            'İstifadə edilən qara siyahını dayandır.', '.rmblacklist amk'
