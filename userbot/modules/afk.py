...
async def mention_afk(mention):
    """ Bu funksiya kimsə sizi etiketlədikdə AFK olduğunuzu bildirməyə imkanı verir.."""
    global COUNT_MSG
    global USERS
    global ISAFK
...
async def afk_on_pm(sender):
    """ Siz afk olduğunuz halda PM göndərənlərə afk olduğunuzu bildirmək funksiyasıdır. """
    global ISAFK
    global USERS
    global COUNT_MSG
...
async def set_afk(afk_e):
    """ .afk Siz afk olduğunuz zaman, əmr insanlara afk olduğunuzu bildirmək üçün istifadə olunur. """
    message = afk_e.text
    ...
    if ISAFK:
        ...
        if BOTLOG:
            await notafk.client.send_message(
                BOTLOG_CHATID,
                "Siz AFK olduğunuz müddətdə " + str(len(USERS)) + "insan sənə  " +
            ...
            for i in USERS:
                ...
                await notafk.client.send_message(
                    ...
                    " sizə " + "`" + str(USERS[i]) + " mesaj gönderdi`",
                )
        COUNT_MSG = 0
        USERS = {}
        AFKREASON = None
